...
\begin{figure}
  \centering
  \subfloat[]{\label{ref_label1}\includegraphics[width=0.5\textwidth]{zyx.png}}\\
  \subfloat[]{\label{ref_label2}\includegraphics[width=0.5\textwidth]{yxc.png}}\\
  \subfloat[]{\label{ref_label3}\includegraphics[width=0.5\textwidth]{xcp.png}}\\
