...
def main():
	...
	# File Names
	train_x = '../../../datasets/train_x.csv'
	train_y = '../../../datasets/train_y.csv'
	test_x 	= '../../../datasets/test_x.csv'
	test_y 	= '../../../datasets/test_y.csv'
	
	train_x_pkl	= '../../../datasets/train_x.npy'
	train_y_pkl = '../../../datasets/train_y.npy'
	test_x_pkl 	= '../../../datasets/test_x.npy'
	test_y_pkl 	= '../../../datasets/test_y.npy'

	p0 = '../../../population_models/parameters/0.csv'
	p1 = '../../../population_models/parameters/1.csv'
	p2 = '../../../population_models/parameters/2.csv'
	p3 = '../../../population_models/parameters/3.csv'
	p4 = '../../../population_models/parameters/4.csv'
	p5 = '../../../population_models/parameters/5.csv'
	p6 = '../../../population_models/parameters/6.csv'
	p7 = '../../../population_models/parameters/7.csv'
	p8 = '../../../population_models/parameters/8.csv'

	# Generate and write data to csv files
	print "\nGenerating data for model number..."
	print"			1 of 8"
